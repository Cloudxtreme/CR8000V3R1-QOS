...
/*****************************************************************************
   ...
   修改内容  : 新生成函数
*****************************************************************************/
NBB_LONG spm_set_wred_basic_cfg(NBB_ULONG key,NBB_ULONG oper, ATG_DCI_WRED_BASIC_DATA **pcb,
    ...
    switch (oper)
    {
        ...
        *pcb = NULL;
        ...
        else
        {
            ...
            /*                          存配置                                         */
            /***************************************************************************/
            ret = fhdrv_fap_qos_set_wred_profile(unit,ptemp->color,ptemp->discard_percent,key,
             ptemp->end_threshold,ptemp->start_threshold,ptemp->discard_percent);
