...
NBB_LONG spm_set_control_bandwidth_cfg(NBB_ULONG oper,
    ATG_DCI_PORT_BANDWIDTH *pcb NBB_CCXT_T NBB_CXT)
{
    /***************************************************************************/
    /* Local Variables                                                         */
    /***************************************************************************/
...
NBB_LONG spm_set_control_que_bandwidth_cfg(NBB_ULONG oper,
    ATG_DCI_QUEUE_BANDWIDTH *pcb NBB_CCXT_T NBB_CXT)
{
    /***************************************************************************/
    /* Local Variables                                                         */
    /***************************************************************************/
...
/*****************************************************************************
   ...
   修改内容  : 新生成函数
*****************************************************************************/
NBB_VOID spm_rcv_dci_set_rcu_pir_control(ATG_DCI_SET_SIGNALING_CTRL *pstSetIps NBB_CCXT_T NBB_CXT)
{
    /***************************************************************************/
    /* Local Variables                                                         */
    /***************************************************************************/
    ...
    ret = spm_set_control_bandwidth_cfg(ulOperBandwidth,pstBandwitchData NBB_CCXT);
    ...
    for(i = 0; i< pstSetIps->queue_bandwidth_num; i++)
    {
        ...
        ret = spm_set_control_que_bandwidth_cfg(ulOperQueBandwidth,pstQueBandwitchData NBB_CCXT);
        if(ATG_DCI_RC_OK != ret)
        {
